...
function[output] = pHDPi_model(taskData)
...
% Discretize outcome state to 0-300 ( screen width)
...
% Initialize particles as a strucutre:
nodes=struct;

% Build a grid of all hyperparamter combinations:
...
% Initilize a distribution over mean and std of outcomes:
