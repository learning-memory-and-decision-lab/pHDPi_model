...
e = errorbar(x1,median(diff_norm_SSE_model_1),median(diff_norm_SSE_model_1)-l_perc_model_1,u_perc_model_1-median(diff_norm_SSE_model_1),'Color',colorpalette('darkblue'),'LineWidth',1)
e.Marker = 'square';
e.MarkerFaceColor = colorpalette('lightblue');
x1 = 1 - 0.5* jitter_ind;
e=errorbar(x1,median(diff_norm_SSE_model_2),median(diff_norm_SSE_model_2)-l_perc_model_2,u_perc_model_2-median(diff_norm_SSE_model_2),'Color',colorpalette('darkred'),'LineWidth',1)
      jitter_ind = 0.1;
...
>>>>>>> 777c352c04df66696fc9f30d2c4d7bb970d85859
e.Marker = 'square';
...
x1 = 1 + 0.25* jitter_ind;
e=errorbar(x1,median(diff_norm_SSE_model_3),median(diff_norm_SSE_model_3)-l_perc_model_3,u_perc_model_3-median(diff_norm_SSE_model_3),'Color',colorpalette('darkyellow'),'LineWidth',1)
...
<<<<<<< HEAD
x1 = 1 + 0.5* jitter_ind;
e = errorbar(x1,median(diff_norm_SSE_model_4),median(diff_norm_SSE_model_4)-l_perc_model_4,u_perc_model_4-median(diff_norm_SSE_model_4),'Color',colorpalette('darkmagenta'),'LineWidth',1)
=======
x1 = 1 + 1* jitter_ind;
...
e = errorbar(x1,median(diff_norm_SSE_humans_1),median(diff_norm_SSE_humans_1)-l_perc_humans_1,u_perc_humans_1-median(diff_norm_SSE_humans_1),'Color',colorpalette('darkblue'),'LineWidth',1)
e.Marker = 'square';
e.MarkerFaceColor = colorpalette('lightblue');

x1 = 2- 0.5* jitter_ind;
e = errorbar(x1,median(diff_norm_SSE_humans_2),median(diff_norm_SSE_humans_2)-l_perc_humans_2,u_perc_humans_2-median(diff_norm_SSE_humans_2),'Color',colorpalette('darkred'),'LineWidth',1)
e.Marker = 'square';
e.MarkerFaceColor = colorpalette('lightred');

x1 = 2 + 0.25* jitter_ind;
e = errorbar(x1,median(diff_norm_SSE_humans_3),median(diff_norm_SSE_humans_3)-l_perc_humans_3,u_perc_humans_3-median(diff_norm_SSE_humans_3),'Color',colorpalette('darkyellow'),'LineWidth',1)
e.Marker = 'square';
e.MarkerFaceColor = colorpalette('lightyellow');

x1 = 2 + 0.5* jitter_ind;
e = errorbar(x1,median(diff_norm_SSE_humans_4),median(diff_norm_SSE_humans_4)-l_perc_humans_4,u_perc_humans_4-median(diff_norm_SSE_humans_4),'Color',colorpalette('darkmagenta'),'LineWidth',1)
=======
x1 = 2 + 0.25* jitter_ind;
