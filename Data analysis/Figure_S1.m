...
errorbar(x1,median(diff_norm_SSE_humans_1),std(diff_norm_SSE_humans_1)./sqrt(num_subs_human),'r')
text(x1, median(diff_norm_SSE_humans_1) + 0.05, 'n.s.','Color','black','FontSize',14)
[r,p] = ttest2((SSE_humans_1(~late_phase)), (SSE_humans_1(late_phase)))

x1 = 2 + 0.5* jitter_ind;
errorbar(x1,median(diff_norm_SSE_humans_2),std(diff_norm_SSE_humans_2)./sqrt(num_subs_human),'b')
text(x1, median(diff_norm_SSE_humans_2) + 0.05, '\ast \ast \ast','Color','red','FontSize',14)
[r,p] = ttest2((SSE_humans_2(~late_phase)), (SSE_humans_2(late_phase)))

x1 = 2 + 0.75* jitter_ind;
errorbar(x1,median(diff_norm_SSE_humans_3),std(diff_norm_SSE_humans_3)./sqrt(num_subs_human),'g')
text(x1, median(diff_norm_SSE_humans_3) + 0.05, '\ast','Color','red','FontSize',14)
[r,p] = ttest2((SSE_humans_3(~late_phase)), (SSE_humans_3(late_phase)))

x1 = 2 + 1* jitter_ind;
errorbar(x1,median(diff_norm_SSE_humans_4),std(diff_norm_SSE_humans_4)./sqrt(num_subs_human),'c')
text(x1, median(diff_norm_SSE_humans_4) + 0.05,'\ast \ast \ast','Color','red','FontSize',14)
[r,p] = ttest2((SSE_humans_4(~late_phase)), (SSE_humans_4(late_phase)))
...
subplot(3,2,3)
hold on
scatter(norm_SSE_model_1(late_phase), norm_SSE_model_1(~late_phase),'o')
scatter(norm_SSE_humans_1(late_phase), norm_SSE_humans_1(~late_phase),'*')
legend('Model','Humans','AutoUpdate','off')
plot([-2,2],[-2,2],'--k')
xlabel('Late Phase SSE(zscore)')
ylabel('Early Phase SSE(zscore)')
title('Changepoint')
ax = gca;
...
subplot(3,2,4)
hold on
scatter(norm_SSE_model_2(late_phase), norm_SSE_model_2(~late_phase),'o')
scatter(norm_SSE_humans_2(late_phase), norm_SSE_humans_2(~late_phase),'*')
legend('Model','Humans','AutoUpdate','off')
plot([-2,2],[-2,2],'--k')
xlabel('Late Phase SSE(zscore)')
ylabel('Early Phase SSE(zscore)')
...
subplot(3,2,5)
hold on
scatter(norm_SSE_model_3(late_phase), norm_SSE_model_3(~late_phase),'o')
scatter(norm_SSE_humans_3(late_phase), norm_SSE_humans_3(~late_phase),'*')
legend('Model','Humans','AutoUpdate','off')
plot([-2,2],[-2,2],'--k')
xlabel('Late Phase SSE(zscore)')
ylabel('Early Phase SSE(zscore)')
...
subplot(3,2,6)
hold on
scatter(norm_SSE_model_4(late_phase), norm_SSE_model_4(~late_phase),'o')
scatter(norm_SSE_humans_4(late_phase), norm_SSE_humans_4(~late_phase),'*')
legend('Model','Humans','AutoUpdate','off')
plot([-2,2],[-2,2],'--k')
xlabel('Late Phase SSE(zscore)')
ylabel('Early Phase SSE(zscore)')
