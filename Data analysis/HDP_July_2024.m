...
<<<<<<< HEAD
comb.alpha= [1 6 11 16]%linspace(1,100,5);
comb.eta = 0:0.2:0.8;
comb.gamma = logspace(-0.25,5,5);
comb.driftVariance = [0.01,25, 225, 625, 1000]; %logspace(-2,3,5); 
comb.stdLogspace =  [100, 225, 625, 1000];%logspace(2,3,5); % [100, 225, 625, 1000];
=======
