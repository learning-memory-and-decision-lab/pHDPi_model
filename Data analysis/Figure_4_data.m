...
comb.alpha= 1:5:20;
comb.eta = 0:0.2:1;
comb.gamma = logspace(-1,1.5,5);
comb.dv = [0.01,25, 225, 625, 1000];
comb.std =[100, 225, 625, 1000];


task_1_gamma_zc = (task_1_gamma - min(comb.gamma))./(max(comb.gamma) - min(comb.gamma));
task_2_gamma_zc = (task_2_gamma - min(comb.gamma))./(max(comb.gamma) - min(comb.gamma));
task_3_gamma_zc = (task_3_gamma - min(comb.gamma))./(max(comb.gamma) - min(comb.gamma));
task_4_gamma_zc = (task_4_gamma - min(comb.gamma))./(max(comb.gamma) - min(comb.gamma));

task_1_alpha_zc = (task_1_alpha - min(comb.alpha))./(max(comb.alpha) - min(comb.alpha));
task_2_alpha_zc = (task_2_alpha - min(comb.alpha))./(max(comb.alpha) - min(comb.alpha));
task_3_alpha_zc = (task_3_alpha - min(comb.alpha))./(max(comb.alpha) - min(comb.alpha));
task_4_alpha_zc = (task_4_alpha - min(comb.alpha))./(max(comb.alpha) - min(comb.alpha));

task_1_eta_zc = (task_1_eta - min(comb.eta))./(max(comb.eta) - min(comb.eta));
task_2_eta_zc = (task_2_eta - min(comb.eta))./(max(comb.eta) - min(comb.eta));
task_3_eta_zc = (task_3_eta - min(comb.eta))./(max(comb.eta) - min(comb.eta));
task_4_eta_zc = (task_4_eta - min(comb.eta))./(max(comb.eta) - min(comb.eta));

task_1_dv_zc = (task_1_dv - min(comb.dv))./(max(comb.dv) - min(comb.dv));
task_2_dv_zc = (task_2_dv - min(comb.dv))./(max(comb.dv) - min(comb.dv));
task_3_dv_zc = (task_3_dv - min(comb.dv))./(max(comb.dv) - min(comb.dv));
task_4_dv_zc = (task_4_dv - min(comb.dv))./(max(comb.dv) - min(comb.dv));

task_1_std_zc = (task_1_std - min(comb.std))./(max(comb.std) - min(comb.std));
task_2_std_zc = (task_2_std - min(comb.std))./(max(comb.std) - min(comb.std));
task_3_std_zc = (task_3_std - min(comb.std))./(max(comb.std) - min(comb.std));
task_4_std_zc = (task_4_std - min(comb.std))./(max(comb.std) - min(comb.std));
